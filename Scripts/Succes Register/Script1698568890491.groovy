...
WebUI.setText(findTestObject('Object Repository/Register/inputname'), nama_toko)

WebUI.setEncryptedText(findTestObject('Object Repository/Register/inputpassword'), 'kmuxlgZjHNY=')

WebUI.setText(findTestObject('Object Repository/Register/inputemail'), 'bebas@gmail.com')
